...
A: Components: resilience, platform, ideation, context, dev-tooling, data, cost, provenance — See architecture-summary.md (PROV-05).
...
A: Tracks: webmcp-challenge-top-10. Do not invent sponsor usage.
